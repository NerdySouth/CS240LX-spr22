...
static inline void kk_std_core_hnd__evv_free(kk_std_core_hnd__evv _x, kk_context_t* _ctx) {
...
static inline void kk_std_core_hnd__ev_free(kk_std_core_hnd__ev _x, kk_context_t* _ctx) {
...
static inline void kk_std_core_hnd__yield_info_free(kk_std_core_hnd__yield_info _x, kk_context_t* _ctx) {
  kk_datatype_free(_x, _ctx);
}
...
static inline kk_std_core_hnd__htag kk_std_core_hnd__copy(kk_std_core_hnd__htag _this, kk_std_core_types__optional tagname0, kk_context_t* _ctx) { /* forall<a> (htag<a>, tagname : optional<string>) -> htag<a> */ 
  ...
  if (kk_std_core_types__is_Optional(tagname0)) {
    kk_box_t _box_x10886 = tagname0._cons.Optional.value;
    kk_string_t _tagname_2006 = kk_string_unbox(_box_x10886);
    kk_std_core_hnd__htag_drop(_this, _ctx);
    _x11188 = _tagname_2006; /*string*/
  }
  else {
    kk_string_t _x = _this.tagname;
    _x11188 = _x; /*string*/
  }
  return kk_std_core_hnd__new_Htag(_x11188, _ctx);
}
...
static inline kk_std_core_hnd__marker kk_std_core_hnd__copy_1(kk_std_core_hnd__marker _this, kk_std_core_types__optional m0, kk_context_t* _ctx) { /* forall<e,a> (marker<e,a>, m : optional<int32>) -> marker<e,a> */ 
  ...
  if (kk_std_core_types__is_Optional(m0)) {
    kk_box_t _box_x10887 = m0._cons.Optional.value;
    int32_t _m_2042 = kk_int32_unbox(_box_x10887, NULL);
    _x11190 = _m_2042; /*int32*/
  }
  else {
    int32_t _x = _this.m;
    _x11190 = _x; /*int32*/
  }
  return kk_std_core_hnd__new_Marker(_x11190, _ctx);
}
...
static inline kk_std_core_hnd__htag kk_std_core_hnd_htag(kk_std_core_hnd__ev ev, kk_context_t* _ctx) { /* forall<a> (ev : ev<a>) -> htag<a> */ 
  {
    struct kk_std_core_hnd_Ev* _con11192 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__htag _x = _con11192->htag;
    return kk_std_core_hnd__htag_dup(_x);
  }
}
...
static inline int32_t kk_std_core_hnd_cfc(kk_std_core_hnd__ev ev, kk_context_t* _ctx) { /* forall<a> (ev : ev<a>) -> cfc */ 
  {
    struct kk_std_core_hnd_Ev* _con11193 = kk_std_core_hnd__as_Ev(ev);
    int32_t _x = _con11193->cfc;
    return _x;
  }
}
...
static inline kk_box_t kk_std_core_hnd__open_none0(kk_function_t f, kk_context_t* _ctx) { /* forall<a,e,e1> (f : () -> e a) -> e1 a */ 
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*std/core/hnd/evv<3282>*/;
  kk_box_t x = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), f, (f, _ctx)); /*3280*/;
...
static inline kk_box_t kk_std_core_hnd__open_none1(kk_function_t f, kk_box_t x1, kk_context_t* _ctx) { /* forall<a,b,e,e1> (f : (a) -> e b, x1 : a) -> e1 b */ 
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*std/core/hnd/evv<3359>*/;
  kk_box_t x = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), f, (f, x1, _ctx)); /*3357*/;
  kk_unit_t keep = kk_Unit;
  kk_evv_set(w,kk_context());
  return x;
}
...
static inline kk_box_t kk_std_core_hnd__open_none2(kk_function_t f, kk_box_t x1, kk_box_t x2, kk_context_t* _ctx) { /* forall<a,b,c,e,e1> (f : (a, b) -> e c, x1 : a, x2 : b) -> e1 c */ 
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*std/core/hnd/evv<3451>*/;
  kk_box_t x = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), f, (f, x1, x2, _ctx)); /*3449*/;
  kk_unit_t keep = kk_Unit;
  kk_evv_set(w,kk_context());
  return x;
}
...
static inline kk_box_t kk_std_core_hnd__open_none3(kk_function_t f, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_context_t* _ctx) { /* forall<a,b,c,d,e,e1> (f : (a, b, c) -> e d, x1 : a, x2 : b, x3 : c) -> e1 d */ 
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*std/core/hnd/evv<3495>*/;
  kk_box_t x = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_box_t, kk_box_t, kk_context_t*), f, (f, x1, x2, x3, _ctx)); /*3493*/;
  kk_unit_t keep = kk_Unit;
  kk_evv_set(w,kk_context());
  return x;
}
...
static inline kk_box_t kk_std_core_hnd__open_none4(kk_function_t f, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_box_t x4, kk_context_t* _ctx) { /* forall<a,b,c,d,a1,e,e1> (f : (a, b, c, d) -> e a1, x1 : a, x2 : b, x3 : c, x4 : d) -> e1 a1 */ 
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*std/core/hnd/evv<3545>*/;
  kk_box_t x = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_box_t, kk_box_t, kk_box_t, kk_context_t*), f, (f, x1, x2, x3, x4, _ctx)); /*3543*/;
  kk_unit_t keep = kk_Unit;
  kk_evv_set(w,kk_context());
  return x;
}
...
static inline kk_box_t kk_std_core_hnd__perform0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : forall<e1,c> (b<e1,c>) -> clause0<a,b,e1,c>) -> e a */ 
  {
    struct kk_std_core_hnd_Ev* _con11212 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con11212->marker;
    kk_box_t h = _con11212->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause0 _match_11185 = kk_function_call(kk_std_core_hnd__clause0, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause0<3632,3634,542,543>*/;
    {
      kk_function_t f = _match_11185.clause;
...
static inline kk_box_t kk_std_core_hnd__perform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    struct kk_std_core_hnd_Ev* _con11213 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con11213->marker;
    kk_box_t h = _con11213->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_11184 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<3736,3737,3739,564,565>*/;
    {
      kk_function_t f = _match_11184.clause;
...
static inline kk_box_t kk_std_core_hnd__perform2(kk_std_core_hnd__ev evx, kk_function_t op, kk_box_t x, kk_box_t y, kk_context_t* _ctx) { /* forall<a,b,c,e,d> (evx : ev<d>, op : forall<e1,a1> (d<e1,a1>) -> clause2<a,b,c,d,e1,a1>, x : a, y : b) -> e c */ 
  {
    struct kk_std_core_hnd_Ev* _con11214 = kk_std_core_hnd__as_Ev(evx);
    kk_std_core_hnd__marker m0 = _con11214->marker;
    kk_box_t h = _con11214->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause2 _match_11183 = kk_function_call(kk_std_core_hnd__clause2, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause2<3856,3857,3858,3860,589,590>*/;
    {
      kk_function_t f = _match_11183.clause;
...
static inline kk_box_t kk_std_core_hnd_xperform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    struct kk_std_core_hnd_Ev* _con11215 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con11215->marker;
    kk_box_t h = _con11215->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_11182 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<4121,4122,4124,693,694>*/;
    {
      kk_function_t f = _match_11182.clause;
      return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), f, (f, m0, ev, x, _ctx));
    }
  }
}
...
struct kk_std_core_hnd_clause_tail_noyield0_fun11216__t {
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noyield0_fun11216(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noyield0_fun11216__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noyield0_fun11216__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail_noyield0_fun11216, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_tail_noyield0(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c> (op : () -> e b) -> clause0<b,c,e,a> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_tail_noyield0_fun11216(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noyield1_fun11217__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noyield1_fun11217(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noyield1_fun11217__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noyield1_fun11217__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail_noyield1_fun11217, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail_noyield1(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d> (op : (b) -> e c) -> clause1<b,c,d,e,a> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_tail_noyield1_fun11217(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noyield2_fun11218__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noyield2_fun11218(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noyield2_fun11218__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noyield2_fun11218__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail_noyield2_fun11218, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail_noyield2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (b, c) -> e d) -> clause2<b,c,d,a1,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail_noyield2_fun11218(op, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_value_fun11221__t {
  struct kk_function_s _base;
  kk_box_t v;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_value_fun11221(kk_box_t v, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_value_fun11221__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_value_fun11221__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_value_fun11221, kk_context());
  _self->v = v;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_value(kk_box_t v, kk_context_t* _ctx) { /* forall<a,e,b,c> (v : a) -> clause0<a,b,e,c> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_value_fun11221(v, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_resume(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e b */ 
  kk_function_t _x11223;
  kk_function_t _brw_11181 = kk_std_core_hnd_k(r, _ctx); /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/;
  kk_std_core_hnd__resume_context_drop(r, _ctx);
  _x11223 = _brw_11181; /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/
  kk_std_core_hnd__resume_result _x11222 = kk_std_core_hnd__new_Deep(x, _ctx); /*std/core/hnd/resume-result<80,81>*/
  return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x11223, (_x11223, _x11222, _ctx));
}
...
static inline kk_box_t kk_std_core_hnd_resume_shallow(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e1 b */ 
  kk_function_t _x11225;
  kk_function_t _brw_11180 = kk_std_core_hnd_k(r, _ctx); /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/;
  kk_std_core_hnd__resume_context_drop(r, _ctx);
  _x11225 = _brw_11180; /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/
  kk_std_core_hnd__resume_result _x11224 = kk_std_core_hnd__new_Shallow(x, _ctx); /*std/core/hnd/resume-result<80,81>*/
  return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x11225, (_x11225, _x11224, _ctx));
}

static inline kk_std_core_hnd__marker kk_std_core_hnd_fresh_marker(kk_context_t* _ctx) { /* forall<e,a> () -> marker<e,a> */ 
  int32_t _x11226 = kk_std_core_hnd_fresh_marker_int(_ctx); /*int32*/
  return kk_std_core_hnd__new_Marker(_x11226, _ctx);
}
...
static inline kk_std_core_hnd__marker kk_std_core_hnd_fresh_marker_named(kk_context_t* _ctx) { /* forall<e,a> () -> marker<e,a> */ 
  int32_t _x11258 = kk_std_core_hnd_fresh_marker_named_int(_ctx); /*int32*/
  return kk_std_core_hnd__new_Marker(_x11258, _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform3(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_context_t* _ctx) { /* forall<a,b,c,d,e,a1> (ev : ev<a1>, op : forall<e1,b1> (a1<e1,b1>) -> clause1<(a, b, c),d,a1,e1,b1>, x1 : a, x2 : b, x3 : c) -> e d */ 
  {
    struct kk_std_core_hnd_Ev* _con11282 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con11282->marker;
    kk_box_t h = _con11282->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_11159 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<(6402, 6403, 6404),6405,6407,1100,1101>*/;
    {
      kk_function_t _fun_unbox_x10945 = _match_11159.clause;
      kk_box_t _x11283;
      kk_std_core_types__tuple3_ _x11284 = kk_std_core_types__new_dash__lp__comma__comma__rp_(x1, x2, x3, _ctx); /*(1008, 1009, 1010)*/
      _x11283 = kk_std_core_types__tuple3__box(_x11284, _ctx); /*51*/
      return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x10945, (_fun_unbox_x10945, m0, ev, _x11283, _ctx));
    }
  }
}
...
static inline kk_box_t kk_std_core_hnd__perform4(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_box_t x4, kk_context_t* _ctx) { /* forall<a,b,c,d,a1,e,b1> (ev : ev<b1>, op : forall<e1,c1> (b1<e1,c1>) -> clause1<(a, b, c, d),a1,b1,e1,c1>, x1 : a, x2 : b, x3 : c, x4 : d) -> e a1 */ 
  {
    struct kk_std_core_hnd_Ev* _con11285 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con11285->marker;
    kk_box_t h = _con11285->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_11158 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<(6456, 6457, 6458, 6459),6460,6462,1132,1133>*/;
    {
      kk_function_t _fun_unbox_x10952 = _match_11158.clause;
      kk_box_t _x11286;
      kk_std_core_types__tuple4_ _x11287 = kk_std_core_types__new_dash__lp__comma__comma__comma__rp_(kk_reuse_null, x1, x2, x3, x4, _ctx); /*(1013, 1014, 1015, 1016)*/
      _x11286 = kk_std_core_types__tuple4__box(_x11287, _ctx); /*51*/
      return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x10952, (_fun_unbox_x10952, m0, ev, _x11286, _ctx));
    }
  }
}
...
static inline kk_box_t kk_std_core_hnd_finalize(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : b) -> e b */ 
  kk_function_t _x11308;
  kk_function_t _brw_11151 = kk_std_core_hnd_k(r, _ctx); /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/;
  kk_std_core_hnd__resume_context_drop(r, _ctx);
  _x11308 = _brw_11151; /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/
  kk_std_core_hnd__resume_result _x11307 = kk_std_core_hnd__new_Finalize(x, _ctx); /*std/core/hnd/resume-result<80,81>*/
  return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x11308, (_x11308, _x11307, _ctx));
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun11322__t {
  struct kk_function_s _base;
...
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun11322(kk_function_t clause0, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun11322__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun11322__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control1_fun11322, kk_context());
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun11323__t {
  struct kk_function_s _base;
  kk_function_t clause0;
  kk_box_t x;
};
extern kk_box_t kk_std_core_hnd_clause_control1_fun11323(kk_function_t _fself, kk_function_t k0, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun11323(kk_function_t clause0, kk_box_t x, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun11323__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun11323__t, 3, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control1_fun11323, kk_context());
  _self->clause0 = clause0;
  _self->x = x;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_control1(kk_function_t clause0, kk_context_t* _ctx) { /* forall<a,b,e,c,d> (clause : (x : a, k : (b) -> e d) -> e d) -> clause1<a,b,c,e,d> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_control1_fun11322(clause0, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun11324__t {
  struct kk_function_s _base;
  kk_function_t clause0;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun11324(kk_function_t clause0, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun11324__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun11324__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control2_fun11324, kk_context());
  _self->clause0 = clause0;
  return &_self->_base;
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun11325__t {
  struct kk_function_s _base;
  kk_function_t clause0;
  kk_box_t x1;
  kk_box_t x2;
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun11325(kk_function_t clause0, kk_box_t x1, kk_box_t x2, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun11325__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun11325__t, 4, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control2_fun11325, kk_context());
  _self->clause0 = clause0;
  _self->x1 = x1;
  _self->x2 = x2;
  return &_self->_base;
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_control2(kk_function_t clause0, kk_context_t* _ctx) { /* forall<a,b,c,e,d,a1> (clause : (x1 : a, x2 : b, k : (c) -> e a1) -> e a1) -> clause2<a,b,c,d,e,a1> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_control2_fun11324(clause0, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_under1_fun11374__t {
  struct kk_function_s _base;
...
static inline kk_function_t kk_std_core_hnd_new_under1_fun11374(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under1_fun11374__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under1_fun11374__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_under1_fun11374, kk_context());
  _self->ev = ev;
  return &_self->_base;
}
...
static inline kk_box_t kk_std_core_hnd_under1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : (a) -> e b, x : a) -> e b */ 
  kk_evv_t w0;
  kk_std_core_hnd__ev _x11373 = kk_std_core_hnd__ev_dup(ev); /*std/core/hnd/ev<9315>*/
  w0 = kk_std_core_hnd_evv_swap_with(_x11373, _ctx); /*std/core/hnd/evv<_9260>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), op, (op, x, _ctx)); /*9313*/;
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    kk_evv_drop(w0, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under1_fun11374(ev, _ctx), _ctx);
  }
  {
...
// lift anonymous function
struct kk_std_core_hnd_under0_fun11376__t {
  struct kk_function_s _base;
  kk_std_core_hnd__ev ev;
};
extern kk_box_t kk_std_core_hnd_under0_fun11376(kk_function_t _fself, kk_function_t cont, kk_box_t res, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_under0_fun11376(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under0_fun11376__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under0_fun11376__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_under0_fun11376, kk_context());
  _self->ev = ev;
  return &_self->_base;
}
...
// lift anonymous function
struct kk_std_core_hnd_under0_fun11378__t {
  struct kk_function_s _base;
  kk_std_core_hnd__ev ev;
};
extern kk_box_t kk_std_core_hnd_under0_fun11378(kk_function_t _fself, kk_function_t cont0, kk_box_t res0, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_under0_fun11378(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under0_fun11378__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under0_fun11378__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_under0_fun11378, kk_context());
  _self->ev = ev;
  return &_self->_base;
}
...
static inline kk_box_t kk_std_core_hnd_under0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : () -> e a) -> e a */ 
  kk_evv_t w0;
  kk_std_core_hnd__ev _x11375 = kk_std_core_hnd__ev_dup(ev); /*std/core/hnd/ev<9368>*/
  w0 = kk_std_core_hnd_evv_swap_with(_x11375, _ctx); /*std/core/hnd/evv<_9320>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), op, (op, _ctx)); /*9366*/;
  kk_unit_t __ = kk_Unit;
  kk_evv_set(w0,kk_context());
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under0_fun11376(ev, _ctx), _ctx);
  }
  {
    kk_std_core_hnd__ev_dropn(ev, (KK_I32(3)), _ctx);
    return y;
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail2_fun11391__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail2_fun11391(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail2_fun11391__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail2_fun11391__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail2_fun11391, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (b, c) -> e d) -> clause2<b,c,d,a1,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail2_fun11391(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_finally(kk_function_t fin, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (fin : () -> e (), action : () -> e a) -> e a */ 
  kk_box_t _x11406 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx)); /*10191*/
  return kk_std_core_hnd_finally_prompt(fin, _x11406, _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_local_var(kk_box_t init, kk_function_t action, kk_context_t* _ctx) { /* forall<a,b,e,h> (init : a, action : (l : local-var<h,a>) -> <local<h>|e> b) -> <local<h>|e> b */ 
  kk_ref_t loc = kk_ref_alloc(init,kk_context()); /*local-var<10560,10557>*/;
  kk_box_t res;
  kk_ref_t _x11423 = kk_ref_dup(loc); /*local-var<10560,10557>*/
  res = kk_function_call(kk_box_t, (kk_function_t, kk_ref_t, kk_context_t*), action, (action, _x11423, _ctx)); /*10558*/
...
static inline kk_std_core_types__either kk_std_core_hnd_unsafe_try_finalize(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> e a) -> e either<yield-info,a> */ 
  kk_box_t _x11436 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx)); /*10788*/
  return kk_std_core_hnd_try_finalize_prompt(_x11436, _ctx);
}
