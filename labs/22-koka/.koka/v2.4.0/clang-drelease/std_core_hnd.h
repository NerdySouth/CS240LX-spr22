...
static inline kk_std_core_hnd__htag kk_std_core_hnd__copy(kk_std_core_hnd__htag _this, kk_std_core_types__optional tagname0, kk_context_t* _ctx) { /* forall<a> (htag<a>, tagname : optional<string>) -> htag<a> */ 
  ...
  if (kk_std_core_types__is_Optional(tagname0)) {
    kk_box_t _box_x10901 = tagname0._cons.Optional.value;
    kk_string_t _tagname_2006 = kk_string_unbox(_box_x10901);
    kk_std_core_hnd__htag_drop(_this, _ctx);
    _x11197 = _tagname_2006; /*string*/
  }
  else {
    kk_string_t _x = _this.tagname;
    _x11197 = _x; /*string*/
  }
  return kk_std_core_hnd__new_Htag(_x11197, _ctx);
}
...
static inline kk_std_core_hnd__marker kk_std_core_hnd__copy_1(kk_std_core_hnd__marker _this, kk_std_core_types__optional m0, kk_context_t* _ctx) { /* forall<e,a> (marker<e,a>, m : optional<int32>) -> marker<e,a> */ 
  ...
  if (kk_std_core_types__is_Optional(m0)) {
    kk_box_t _box_x10902 = m0._cons.Optional.value;
    int32_t _m_2042 = kk_int32_unbox(_box_x10902, NULL);
    _x11199 = _m_2042; /*int32*/
  }
  else {
    int32_t _x = _this.m;
    _x11199 = _x; /*int32*/
  }
  return kk_std_core_hnd__new_Marker(_x11199, _ctx);
}
...
static inline kk_std_core_hnd__htag kk_std_core_hnd_htag(kk_std_core_hnd__ev ev, kk_context_t* _ctx) { /* forall<a> (ev : ev<a>) -> htag<a> */ 
  {
    struct kk_std_core_hnd_Ev* _con11201 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__htag _x = _con11201->htag;
...
static inline int32_t kk_std_core_hnd_cfc(kk_std_core_hnd__ev ev, kk_context_t* _ctx) { /* forall<a> (ev : ev<a>) -> cfc */ 
  {
    struct kk_std_core_hnd_Ev* _con11202 = kk_std_core_hnd__as_Ev(ev);
    int32_t _x = _con11202->cfc;
    return _x;
  }
}
...
static inline kk_box_t kk_std_core_hnd__perform0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : forall<e1,c> (b<e1,c>) -> clause0<a,b,e1,c>) -> e a */ 
  {
    struct kk_std_core_hnd_Ev* _con11221 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con11221->marker;
    kk_box_t h = _con11221->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause0 _match_11194 = kk_function_call(kk_std_core_hnd__clause0, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause0<3632,3634,542,543>*/;
    {
      kk_function_t f = _match_11194.clause;
...
static inline kk_box_t kk_std_core_hnd__perform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    struct kk_std_core_hnd_Ev* _con11222 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con11222->marker;
    kk_box_t h = _con11222->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_11193 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<3736,3737,3739,564,565>*/;
    {
      kk_function_t f = _match_11193.clause;
...
static inline kk_box_t kk_std_core_hnd__perform2(kk_std_core_hnd__ev evx, kk_function_t op, kk_box_t x, kk_box_t y, kk_context_t* _ctx) { /* forall<a,b,c,e,d> (evx : ev<d>, op : forall<e1,a1> (d<e1,a1>) -> clause2<a,b,c,d,e1,a1>, x : a, y : b) -> e c */ 
  {
    struct kk_std_core_hnd_Ev* _con11223 = kk_std_core_hnd__as_Ev(evx);
    kk_std_core_hnd__marker m0 = _con11223->marker;
    kk_box_t h = _con11223->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause2 _match_11192 = kk_function_call(kk_std_core_hnd__clause2, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause2<3856,3857,3858,3860,589,590>*/;
    {
      kk_function_t f = _match_11192.clause;
...
static inline kk_box_t kk_std_core_hnd_xperform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    struct kk_std_core_hnd_Ev* _con11224 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con11224->marker;
    kk_box_t h = _con11224->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_11191 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<4121,4122,4124,693,694>*/;
    {
      kk_function_t f = _match_11191.clause;
      return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), f, (f, m0, ev, x, _ctx));
    }
  }
}
...
struct kk_std_core_hnd_clause_tail_noyield0_fun11225__t {
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noyield0_fun11225(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noyield0_fun11225__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noyield0_fun11225__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail_noyield0_fun11225, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_tail_noyield0(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c> (op : () -> e b) -> clause0<b,c,e,a> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_tail_noyield0_fun11225(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noyield1_fun11226__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noyield1_fun11226(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noyield1_fun11226__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noyield1_fun11226__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail_noyield1_fun11226, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail_noyield1(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d> (op : (b) -> e c) -> clause1<b,c,d,e,a> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_tail_noyield1_fun11226(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noyield2_fun11227__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noyield2_fun11227(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noyield2_fun11227__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noyield2_fun11227__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail_noyield2_fun11227, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail_noyield2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (b, c) -> e d) -> clause2<b,c,d,a1,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail_noyield2_fun11227(op, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_value_fun11230__t {
  struct kk_function_s _base;
  kk_box_t v;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_value_fun11230(kk_box_t v, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_value_fun11230__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_value_fun11230__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_value_fun11230, kk_context());
  _self->v = v;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_value(kk_box_t v, kk_context_t* _ctx) { /* forall<a,e,b,c> (v : a) -> clause0<a,b,e,c> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_value_fun11230(v, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_resume(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e b */ 
  kk_function_t _x11232;
  kk_function_t _brw_11190 = kk_std_core_hnd_k(r, _ctx); /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/;
  kk_std_core_hnd__resume_context_drop(r, _ctx);
  _x11232 = _brw_11190; /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/
  kk_std_core_hnd__resume_result _x11231 = kk_std_core_hnd__new_Deep(x, _ctx); /*std/core/hnd/resume-result<80,81>*/
  return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x11232, (_x11232, _x11231, _ctx));
}
...
static inline kk_box_t kk_std_core_hnd_resume_shallow(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e1 b */ 
  kk_function_t _x11234;
  kk_function_t _brw_11189 = kk_std_core_hnd_k(r, _ctx); /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/;
  kk_std_core_hnd__resume_context_drop(r, _ctx);
  _x11234 = _brw_11189; /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/
  kk_std_core_hnd__resume_result _x11233 = kk_std_core_hnd__new_Shallow(x, _ctx); /*std/core/hnd/resume-result<80,81>*/
  return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x11234, (_x11234, _x11233, _ctx));
}

static inline kk_std_core_hnd__marker kk_std_core_hnd_fresh_marker(kk_context_t* _ctx) { /* forall<e,a> () -> marker<e,a> */ 
  int32_t _x11235 = kk_std_core_hnd_fresh_marker_int(_ctx); /*int32*/
  return kk_std_core_hnd__new_Marker(_x11235, _ctx);
}
...
static inline kk_std_core_hnd__marker kk_std_core_hnd_fresh_marker_named(kk_context_t* _ctx) { /* forall<e,a> () -> marker<e,a> */ 
  int32_t _x11267 = kk_std_core_hnd_fresh_marker_named_int(_ctx); /*int32*/
  return kk_std_core_hnd__new_Marker(_x11267, _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform3(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_context_t* _ctx) { /* forall<a,b,c,d,e,a1> (ev : ev<a1>, op : forall<e1,b1> (a1<e1,b1>) -> clause1<(a, b, c),d,a1,e1,b1>, x1 : a, x2 : b, x3 : c) -> e d */ 
  {
    struct kk_std_core_hnd_Ev* _con11291 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con11291->marker;
    kk_box_t h = _con11291->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_11168 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<(6402, 6403, 6404),6405,6407,1100,1101>*/;
    {
      kk_function_t _fun_unbox_x10960 = _match_11168.clause;
      kk_box_t _x11292;
      kk_std_core_types__tuple3_ _x11293 = kk_std_core_types__new_dash__lp__comma__comma__rp_(x1, x2, x3, _ctx); /*(1008, 1009, 1010)*/
      _x11292 = kk_std_core_types__tuple3__box(_x11293, _ctx); /*51*/
      return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x10960, (_fun_unbox_x10960, m0, ev, _x11292, _ctx));
    }
  }
}
...
static inline kk_box_t kk_std_core_hnd__perform4(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_box_t x4, kk_context_t* _ctx) { /* forall<a,b,c,d,a1,e,b1> (ev : ev<b1>, op : forall<e1,c1> (b1<e1,c1>) -> clause1<(a, b, c, d),a1,b1,e1,c1>, x1 : a, x2 : b, x3 : c, x4 : d) -> e a1 */ 
  {
    struct kk_std_core_hnd_Ev* _con11294 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con11294->marker;
    kk_box_t h = _con11294->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_11167 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<(6456, 6457, 6458, 6459),6460,6462,1132,1133>*/;
    {
      kk_function_t _fun_unbox_x10967 = _match_11167.clause;
      kk_box_t _x11295;
      kk_std_core_types__tuple4_ _x11296 = kk_std_core_types__new_dash__lp__comma__comma__comma__rp_(kk_reuse_null, x1, x2, x3, x4, _ctx); /*(1013, 1014, 1015, 1016)*/
      _x11295 = kk_std_core_types__tuple4__box(_x11296, _ctx); /*51*/
      return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x10967, (_fun_unbox_x10967, m0, ev, _x11295, _ctx));
    }
  }
}
...
static inline kk_box_t kk_std_core_hnd_finalize(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : b) -> e b */ 
  kk_function_t _x11317;
  kk_function_t _brw_11160 = kk_std_core_hnd_k(r, _ctx); /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/;
  kk_std_core_hnd__resume_context_drop(r, _ctx);
  _x11317 = _brw_11160; /*(std/core/hnd/resume-result<2923,2926>) -> 2924 2926*/
  kk_std_core_hnd__resume_result _x11316 = kk_std_core_hnd__new_Finalize(x, _ctx); /*std/core/hnd/resume-result<80,81>*/
  return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x11317, (_x11317, _x11316, _ctx));
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun11334__t {
  struct kk_function_s _base;
...
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun11334(kk_function_t clause0, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun11334__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun11334__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control1_fun11334, kk_context());
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun11335__t {
  struct kk_function_s _base;
  kk_function_t clause0;
  kk_box_t x;
};
extern kk_box_t kk_std_core_hnd_clause_control1_fun11335(kk_function_t _fself, kk_function_t k0, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun11335(kk_function_t clause0, kk_box_t x, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun11335__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun11335__t, 3, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control1_fun11335, kk_context());
  _self->clause0 = clause0;
  _self->x = x;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_control1(kk_function_t clause0, kk_context_t* _ctx) { /* forall<a,b,e,c,d> (clause : (x : a, k : (b) -> e d) -> e d) -> clause1<a,b,c,e,d> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_control1_fun11334(clause0, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun11336__t {
  struct kk_function_s _base;
  kk_function_t clause0;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun11336(kk_function_t clause0, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun11336__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun11336__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control2_fun11336, kk_context());
  _self->clause0 = clause0;
  return &_self->_base;
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun11337__t {
  struct kk_function_s _base;
  kk_function_t clause0;
  kk_box_t x1;
  kk_box_t x2;
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun11337(kk_function_t clause0, kk_box_t x1, kk_box_t x2, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun11337__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun11337__t, 4, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control2_fun11337, kk_context());
  _self->clause0 = clause0;
  _self->x1 = x1;
  _self->x2 = x2;
  return &_self->_base;
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_control2(kk_function_t clause0, kk_context_t* _ctx) { /* forall<a,b,c,e,d,a1> (clause : (x1 : a, x2 : b, k : (c) -> e a1) -> e a1) -> clause2<a,b,c,d,e,a1> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_control2_fun11336(clause0, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_under1_fun11392__t {
  struct kk_function_s _base;
...
static inline kk_function_t kk_std_core_hnd_new_under1_fun11392(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under1_fun11392__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under1_fun11392__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_under1_fun11392, kk_context());
  _self->ev = ev;
  return &_self->_base;
}
...
static inline kk_box_t kk_std_core_hnd_under1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : (a) -> e b, x : a) -> e b */ 
  kk_evv_t w0;
  kk_std_core_hnd__ev _x11391 = kk_std_core_hnd__ev_dup(ev); /*std/core/hnd/ev<9315>*/
  w0 = kk_std_core_hnd_evv_swap_with(_x11391, _ctx); /*std/core/hnd/evv<_9260>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), op, (op, x, _ctx)); /*9313*/;
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    kk_evv_drop(w0, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under1_fun11392(ev, _ctx), _ctx);
  }
  {
...
// lift anonymous function
struct kk_std_core_hnd_under0_fun11394__t {
  struct kk_function_s _base;
  kk_std_core_hnd__ev ev;
};
extern kk_box_t kk_std_core_hnd_under0_fun11394(kk_function_t _fself, kk_function_t cont, kk_box_t res, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_under0_fun11394(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under0_fun11394__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under0_fun11394__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_under0_fun11394, kk_context());
  _self->ev = ev;
  return &_self->_base;
}
...
// lift anonymous function
struct kk_std_core_hnd_under0_fun11396__t {
  struct kk_function_s _base;
  kk_std_core_hnd__ev ev;
};
extern kk_box_t kk_std_core_hnd_under0_fun11396(kk_function_t _fself, kk_function_t cont0, kk_box_t res0, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_under0_fun11396(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under0_fun11396__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under0_fun11396__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_under0_fun11396, kk_context());
  _self->ev = ev;
  return &_self->_base;
}
...
static inline kk_box_t kk_std_core_hnd_under0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : () -> e a) -> e a */ 
  kk_evv_t w0;
  kk_std_core_hnd__ev _x11393 = kk_std_core_hnd__ev_dup(ev); /*std/core/hnd/ev<9368>*/
  w0 = kk_std_core_hnd_evv_swap_with(_x11393, _ctx); /*std/core/hnd/evv<_9320>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), op, (op, _ctx)); /*9366*/;
  kk_unit_t __ = kk_Unit;
  kk_evv_set(w0,kk_context());
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under0_fun11394(ev, _ctx), _ctx);
  }
  {
    kk_std_core_hnd__ev_dropn(ev, (KK_I32(3)), _ctx);
    return y;
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail2_fun11409__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail2_fun11409(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail2_fun11409__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail2_fun11409__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail2_fun11409, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (b, c) -> e d) -> clause2<b,c,d,a1,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail2_fun11409(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_finally(kk_function_t fin, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (fin : () -> e (), action : () -> e a) -> e a */ 
  kk_box_t _x11424 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx)); /*10191*/
  return kk_std_core_hnd_finally_prompt(fin, _x11424, _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_local_var(kk_box_t init, kk_function_t action, kk_context_t* _ctx) { /* forall<a,b,e,h> (init : a, action : (l : local-var<h,a>) -> <local<h>|e> b) -> <local<h>|e> b */ 
  ...
  kk_box_t res;
  kk_ref_t _x11441 = kk_ref_dup(loc); /*local-var<10560,10557>*/
  res = kk_function_call(kk_box_t, (kk_function_t, kk_ref_t, kk_context_t*), action, (action, _x11441, _ctx)); /*10558*/
...
static inline kk_std_core_types__either kk_std_core_hnd_unsafe_try_finalize(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> e a) -> e either<yield-info,a> */ 
  kk_box_t _x11454 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx)); /*10788*/
  return kk_std_core_hnd_try_finalize_prompt(_x11454, _ctx);
}
