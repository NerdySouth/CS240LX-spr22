...
static inline kk_std_core_hnd__clause1 kk_prog_assert__select_assert(kk_prog_assert__hnd_assert hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : .hnd-assert<e,a>) -> std/core/hnd/clause1<bool,(),.hnd-assert,e,a> */ 
  {
    struct kk_prog_assert__Hnd_assert* _con658 = kk_prog_assert__as_Hnd_assert(hnd);
    kk_std_core_hnd__clause1 ctl_assert = _con658->ctl_assert;
...
static inline kk_unit_t kk_prog_assert_assert(bool value, kk_context_t* _ctx) { /* (value : bool) -> assert () */ 
  kk_std_core_hnd__ev ev_525;
  kk_ssize_t _x659 = (KK_IZ(0)); /*ssize_t*/
  ev_525 = kk_evv_at(_x659,kk_context()); /*std/core/hnd/ev<prog/assert/.hnd-assert>*/
  kk_box_t _x660;
  {
    struct kk_std_core_hnd_Ev* _con661 = kk_std_core_hnd__as_Ev(ev_525);
    kk_std_core_hnd__marker m0 = _con661->marker;
    kk_box_t _box_x557 = _con661->hnd;
    kk_prog_assert__hnd_assert h = kk_prog_assert__hnd_assert_unbox(_box_x557, NULL);
    kk_prog_assert__hnd_assert_dup(h);
    kk_std_core_hnd__clause1 _match_653;
    kk_std_core_hnd__clause1 _brw_654 = kk_prog_assert__select_assert(h, _ctx); /*std/core/hnd/clause1<bool,(),prog/assert/.hnd-assert,93,94>*/;
    kk_prog_assert__hnd_assert_drop(h, _ctx);
    _match_653 = _brw_654; /*std/core/hnd/clause1<bool,(),prog/assert/.hnd-assert,93,94>*/
    {
      kk_function_t _fun_unbox_x561 = _match_653.clause;
      _x660 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x561, (_fun_unbox_x561, m0, ev_525, kk_bool_box(value), _ctx)); /*52*/
    }
  }
  kk_unit_unbox(_x660); return kk_Unit;
}
