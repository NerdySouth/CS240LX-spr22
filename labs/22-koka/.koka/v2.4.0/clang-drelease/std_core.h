...
static inline bool kk_std_core_is_exnError(kk_std_core__exception_info kkloc_exception_info, kk_context_t* _ctx) { /* (exception-info : exception-info) -> bool */ 
  if (kk_std_core__is_ExnError(kkloc_exception_info)) {
    struct kk_std_core_ExnError* _con20459 = kk_std_core__as_ExnError(kkloc_exception_info);
    return true;
  }
  {
    return false;
...
static inline bool kk_std_core_is_exnAssert(kk_std_core__exception_info kkloc_exception_info, kk_context_t* _ctx) { /* (exception-info : exception-info) -> bool */ 
  if (kk_std_core__is_ExnAssert(kkloc_exception_info)) {
    struct kk_std_core_ExnAssert* _con20460 = kk_std_core__as_ExnAssert(kkloc_exception_info);
    return true;
  }
  {
    return false;
...
static inline bool kk_std_core_is_exnTodo(kk_std_core__exception_info kkloc_exception_info, kk_context_t* _ctx) { /* (exception-info : exception-info) -> bool */ 
  if (kk_std_core__is_ExnTodo(kkloc_exception_info)) {
    struct kk_std_core_ExnTodo* _con20461 = kk_std_core__as_ExnTodo(kkloc_exception_info);
    return true;
  }
  {
    return false;
...
static inline bool kk_std_core_is_exnRange(kk_std_core__exception_info kkloc_exception_info, kk_context_t* _ctx) { /* (exception-info : exception-info) -> bool */ 
  if (kk_std_core__is_ExnRange(kkloc_exception_info)) {
    struct kk_std_core_ExnRange* _con20462 = kk_std_core__as_ExnRange(kkloc_exception_info);
    return true;
  }
  {
    return false;
...
static inline bool kk_std_core_is_exnPattern(kk_std_core__exception_info kkloc_exception_info, kk_context_t* _ctx) { /* (exception-info : exception-info) -> bool */ 
  if (kk_std_core__is_ExnPattern(kkloc_exception_info)) {
    struct kk_std_core_ExnPattern* _con20463 = kk_std_core__as_ExnPattern(kkloc_exception_info);
    return true;
  }
  {
    return false;
...
static inline bool kk_std_core_is_exnSystem(kk_std_core__exception_info kkloc_exception_info, kk_context_t* _ctx) { /* (exception-info : exception-info) -> bool */ 
  if (kk_std_core__is_ExnSystem(kkloc_exception_info)) {
    struct kk_std_core_ExnSystem* _con20464 = kk_std_core__as_ExnSystem(kkloc_exception_info);
    return true;
  }
  {
    return false;
...
static inline bool kk_std_core_is_exnInternal(kk_std_core__exception_info kkloc_exception_info, kk_context_t* _ctx) { /* (exception-info : exception-info) -> bool */ 
  if (kk_std_core__is_ExnInternal(kkloc_exception_info)) {
    struct kk_std_core_ExnInternal* _con20465 = kk_std_core__as_ExnInternal(kkloc_exception_info);
    return true;
  }
  {
    return false;
...
static inline kk_std_core__delayed kk_std_core__copy_1(kk_std_core__delayed _this, kk_std_core_types__optional dref0, kk_context_t* _ctx) { /* forall<e,a> (delayed<e,a>, dref : optional<ref<global,either<() -> e a,a>>>) -> delayed<e,a> */ 
  ...
  if (kk_std_core_types__is_Optional(dref0)) {
    kk_box_t _box_x18532 = dref0._cons.Optional.value;
    kk_ref_t _dref_1727 = kk_ref_unbox(_box_x18532, NULL);
    kk_std_core__delayed_drop(_this, _ctx);
    _x20470 = _dref_1727; /*ref<global,either<() -> 1739 1740,1740>>*/
  }
  else {
    kk_ref_t _x = _this.dref;
    _x20470 = _x; /*ref<global,either<() -> 1739 1740,1740>>*/
  }
  return kk_std_core__new_Delay(_x20470, _ctx);
}
...
static inline bool kk_std_core_is_cons(kk_std_core__list list0, kk_context_t* _ctx) { /* forall<a> (list : list<a>) -> bool */ 
  if (kk_std_core__is_Cons(list0)) {
    struct kk_std_core_Cons* _con20472 = kk_std_core__as_Cons(list0);
    return true;
  }
  {
    return false;
...
static inline kk_box_t kk_std_core_head(kk_std_core__stream stream, kk_context_t* _ctx) { /* forall<a> (stream : stream<a>) -> a */ 
  {
    struct kk_std_core_Next* _con20479 = kk_std_core__as_Next(stream);
    kk_box_t _x = _con20479->head;
...
static inline kk_std_core__stream kk_std_core_tail(kk_std_core__stream stream, kk_context_t* _ctx) { /* forall<a> (stream : stream<a>) -> stream<a> */ 
  {
    struct kk_std_core_Next* _con20480 = kk_std_core__as_Next(stream);
    kk_std_core__stream _x = _con20480->tail;
...
static inline kk_std_core_hnd__clause1 kk_std_core__select_throw_exn(kk_std_core__hnd_exn hnd, kk_context_t* _ctx) { /* forall<a,e,b> (hnd : .hnd-exn<e,b>) -> std/core/hnd/clause1<exception,a,.hnd-exn,e,b> */ 
  {
    struct kk_std_core__Hnd_exn* _con20486 = kk_std_core__as_Hnd_exn(hnd);
    kk_std_core_hnd__clause1 ctl_throw_exn = _con20486->ctl_throw_exn;
...
static inline kk_string_t kk_std_core_string_4(kk_std_core_types__maybe ms, kk_context_t* _ctx) { /* (ms : maybe<string>) -> string */ 
  ...
  {
    kk_box_t _box_x18549 = ms._cons.Just.value;
    kk_string_t s = kk_string_unbox(_box_x18549);
    return s;
  }
}
...
static inline kk_std_core__list kk_std_core_concat(kk_std_core__list xss, kk_context_t* _ctx) { /* forall<a> (xss : list<list<a>>) -> list<a> */ 
  return kk_std_core__lift17272_concat(kk_std_core__new_Nil(_ctx), xss, _ctx);
}
...
struct kk_std_core_const_fun20501__t_1 {
  struct kk_function_s _base;
  kk_box_t default0;
};
extern kk_box_t kk_std_core_const_fun20501_1(kk_function_t _fself, kk_box_t ___wildcard__110__6, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_new_const_fun20501_1(kk_box_t default0, kk_context_t* _ctx) {
  struct kk_std_core_const_fun20501__t_1* _self = kk_function_alloc_as(struct kk_std_core_const_fun20501__t_1, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_const_fun20501_1, kk_context());
...
static inline kk_function_t kk_std_core_const_1(kk_box_t default0, kk_context_t* _ctx) { /* forall<a,b> (default : a) -> total ((x : b) -> a) */ 
  return kk_std_core_new_const_fun20501_1(default0, _ctx);
}
...
static inline kk_std_core__list kk_std_core_flatmap(kk_std_core__list xs, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,e> (xs : list<a>, f : (a) -> e list<b>) -> e list<b> */ 
  return kk_std_core__lift17273_flatmap(f, kk_std_core__new_Nil(_ctx), xs, _ctx);
}
...
static inline kk_std_core__list kk_std_core_reverse_append(kk_std_core__list xs, kk_std_core__list tl, kk_context_t* _ctx) { /* forall<a> (xs : list<a>, tl : list<a>) -> list<a> */ 
  return kk_std_core__lift17274_reverse_append(tl, xs, _ctx);
}
 
// monadic lift

static inline kk_box_t kk_std_core__mlift17986_force(kk_ref_t r, kk_box_t x0, kk_context_t* _ctx) { /* forall<a,e> (r : ref<global,either<() -> e a,a>>, x0 : a) -> <st<global>,div|e> a */ 
  kk_unit_t __ = kk_Unit;
  kk_unit_t _brw_20344 = kk_Unit;
  kk_box_t _x20523;
  kk_std_core_types__either _x20524;
  kk_box_t _x20525 = kk_box_dup(x0); /*2592*/
  _x20524 = kk_std_core_types__new_Right(_x20525, _ctx); /*either<1024,1025>*/
  _x20523 = kk_std_core_types__either_box(_x20524, _ctx); /*1000*/
  kk_ref_set_borrow(r,_x20523,kk_context());
  kk_ref_drop(r, _ctx);
  _brw_20344;
  return x0;
}
...
static inline kk_std_core__list kk_std_core_map_peek(kk_std_core__list xs, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,e> (xs : list<a>, f : (value : a, rest : list<a>) -> e b) -> e list<b> */ 
  return kk_std_core__lift17276_map_peek(f, xs, _ctx);
}
...
static inline kk_integer_t kk_std_core_mbint(kk_std_core_types__maybe m, kk_context_t* _ctx) { /* (m : maybe<int>) -> int */ 
  ...
  {
    kk_box_t _box_x18670 = m._cons.Just.value;
    kk_integer_t i = kk_integer_unbox(_box_x18670);
    return i;
  }
}
...
static inline kk_box_t kk_std_core_on_exit(kk_function_t hndler, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (hndler : () -> e (), action : () -> e a) -> e a */ 
  kk_box_t _x20572 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx)); /*2834*/
  return kk_std_core_hnd_finally_prompt(hndler, _x20572, _ctx);
}
...
static inline kk_char_t kk_std_core__lp__plus__3_rp_(kk_char_t c, kk_char_t d, kk_context_t* _ctx) { /* (c : char, d : char) -> total char */ 
  ...
  kk_integer_t _x20587 = kk_integer_add(x_16954,y_16955,kk_context()); /*int*/
  return kk_integer_clamp32(_x20587,kk_context());
}
...
static inline kk_char_t kk_std_core__lp__dash__3_rp_(kk_char_t c, kk_char_t d, kk_context_t* _ctx) { /* (c : char, d : char) -> total char */ 
  ...
  kk_integer_t _x20592 = kk_integer_sub(x_16956,y_16957,kk_context()); /*int*/
  return kk_integer_clamp32(_x20592,kk_context());
}
...
static inline bool kk_std_core__lp__lt__7_rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  ...
  kk_integer_t _brw_20315;
  if (kk_std_core_types__is_Lt(x0_16965)) {
    _brw_20315 = kk_integer_from_small(-1); /*int*/
    goto _match20603;
  }
  if (kk_std_core_types__is_Eq(x0_16965)) {
    _brw_20315 = kk_integer_from_small(0); /*int*/
    goto _match20603;
  }
  {
    _brw_20315 = kk_integer_from_small(1); /*int*/
  ...
  _match20603: ;
  bool _brw_20316 = kk_integer_eq_borrow(_brw_20315,(kk_integer_from_small(-1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_20315, _ctx);
  return _brw_20316;
}
...
static inline bool kk_std_core__lp__gt__5_rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  ...
  kk_integer_t _brw_20310;
  if (kk_std_core_types__is_Lt(x0_16972)) {
    _brw_20310 = kk_integer_from_small(-1); /*int*/
    goto _match20606;
  }
  if (kk_std_core_types__is_Eq(x0_16972)) {
    _brw_20310 = kk_integer_from_small(0); /*int*/
    goto _match20606;
  }
  {
    _brw_20310 = kk_integer_from_small(1); /*int*/
  ...
  _match20606: ;
  bool _brw_20311 = kk_integer_eq_borrow(_brw_20310,(kk_integer_from_small(1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_20310, _ctx);
  return _brw_20311;
}
...
static inline kk_std_core_types__order kk_std_core_compare_1(kk_char_t x, kk_char_t y, kk_context_t* _ctx) { /* (x : char, y : char) -> order */ 
  bool _match_20308 = (x < y); /*bool*/;
  if (_match_20308) {
    return kk_std_core_types__new_Lt(_ctx);
  }
  {
    bool _match_20309 = (x > y); /*bool*/;
    if (_match_20309) {
...
static inline bool kk_std_core__lp__gt__eq__6_rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  ...
  kk_integer_t _brw_20303;
  if (kk_std_core_types__is_Lt(x0_16988)) {
    _brw_20303 = kk_integer_from_small(-1); /*int*/
    goto _match20609;
  }
  if (kk_std_core_types__is_Eq(x0_16988)) {
    _brw_20303 = kk_integer_from_small(0); /*int*/
    goto _match20609;
  }
  {
    _brw_20303 = kk_integer_from_small(1); /*int*/
  ...
  _match20609: ;
  bool _brw_20304 = kk_integer_gt_borrow(_brw_20303,(kk_integer_from_small(-1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_20303, _ctx);
  return _brw_20304;
}
...
static inline bool kk_std_core__lp__lt__eq__7_rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  ...
  kk_integer_t _brw_20298;
  if (kk_std_core_types__is_Lt(x0_17000)) {
    _brw_20298 = kk_integer_from_small(-1); /*int*/
    goto _match20631;
  }
  if (kk_std_core_types__is_Eq(x0_17000)) {
    _brw_20298 = kk_integer_from_small(0); /*int*/
    goto _match20631;
  }
  {
    _brw_20298 = kk_integer_from_small(1); /*int*/
  ...
  _match20631: ;
  bool _brw_20299 = kk_integer_lt_borrow(_brw_20298,(kk_integer_from_small(1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_20298, _ctx);
  return _brw_20299;
}
...
static inline kk_unit_t kk_std_core_forz(kk_ssize_t start0, kk_ssize_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (start : ssize_t, end : ssize_t, action : (ssize_t) -> e ()) -> e () */ 
  kk_std_core__lift17279_forz(action, end, start0, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_foreach_indexedz(kk_vector_t v, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (v : vector<a>, f : (ssize_t, a) -> e ()) -> e () */ 
  kk_ssize_t start0_17006 = (KK_IZ(0)); /*ssize_t*/;
  kk_ssize_t end_17007;
  kk_ssize_t _x20641 = kk_vector_len_borrow(v); /*ssize_t*/
  end_17007 = kk_std_core_decr_1(_x20641, _ctx); /*ssize_t*/
  kk_std_core__lift17280_foreach_indexedz(end_17007, f, v, start0_17006, _ctx); return kk_Unit;
}
...
static inline kk_integer_t kk_std_core_length_1(kk_std_core__list xs, kk_context_t* _ctx) { /* forall<a> (xs : list<a>) -> int */ 
  return kk_std_core__lift17281_length_1(xs, kk_integer_from_small(0), _ctx);
}
 
// Return the length of a vector.

static inline kk_integer_t kk_std_core_length_2(kk_vector_t v, kk_context_t* _ctx) { /* forall<a> (v : vector<a>) -> int */ 
  kk_ssize_t _x20644 = kk_vector_len_borrow(v); /*ssize_t*/
  return kk_integer_from_ssize_t(_x20644,kk_context());
}
...
static inline kk_std_core__list kk_std_core_list_4(kk_char_t lo, kk_char_t hi, kk_context_t* _ctx) { /* (lo : char, hi : char) -> total list<char> */ 
  kk_std_core__list _x20735;
  kk_integer_t _x20736 = kk_integer_from_int(lo,kk_context()); /*int*/
  kk_integer_t _x20737 = kk_integer_from_int(hi,kk_context()); /*int*/
  _x20735 = kk_std_core_list(_x20736, _x20737, _ctx); /*list<int>*/
  return kk_std_core__lift17478_list_4(_x20735, _ctx);
}
...
static inline kk_std_core_types__maybe kk_std_core__mlift18000_map(kk_box_t _y_17693, kk_context_t* _ctx) { /* forall<a,e> (a) -> e maybe<a> */ 
  return kk_std_core_types__new_Just(_y_17693, _ctx);
}
...
static inline kk_std_core_types__either kk_std_core__mlift18001_map_1(kk_box_t _y_17695, kk_context_t* _ctx) { /* forall<a,b,e> (b) -> e either<a,b> */ 
  return kk_std_core_types__new_Right(_y_17695, _ctx);
}
...
static inline kk_std_core_types__tuple2_ kk_std_core__mlift18002_map_2(kk_box_t _y_17697, kk_box_t _y_17698, kk_context_t* _ctx) { /* forall<a,e> (a, a) -> e (a, a) */ 
  return kk_std_core_types__new_dash__lp__comma__rp_(_y_17697, _y_17698, _ctx);
}
...
static inline kk_std_core_types__tuple3_ kk_std_core__mlift18004_map_3(kk_box_t _y_17699, kk_box_t _y_17700, kk_box_t _y_17701, kk_context_t* _ctx) { /* forall<a,e> (a, a, a) -> e (a, a, a) */ 
  return kk_std_core_types__new_dash__lp__comma__comma__rp_(_y_17699, _y_17700, _y_17701, _ctx);
}
...
static inline kk_std_core_types__tuple4_ kk_std_core__mlift18007_map_4(kk_box_t _y_17702, kk_box_t _y_17703, kk_box_t _y_17704, kk_box_t _y_17705, kk_context_t* _ctx) { /* forall<a,e> (a, a, a, a) -> e (a, a, a, a) */ 
  return kk_std_core_types__new_dash__lp__comma__comma__comma__rp_(kk_reuse_null, _y_17702, _y_17703, _y_17704, _y_17705, _ctx);
}
...
static inline kk_vector_t kk_std_core__mlift18012_map_7(kk_vector_t w, kk_unit_t wild__0, kk_context_t* _ctx) { /* forall<a,e> (w : vector<a>, wild_0 : ()) -> e vector<a> */ 
  return w;
}
...
static inline kk_std_core_types__order kk_std_core_sign_1(double d, kk_context_t* _ctx) { /* (d : float64) -> order */ 
  bool _match_20252 = (d < (0.0)); /*bool*/;
  if (_match_20252) {
    return kk_std_core_types__new_Lt(_ctx);
  }
  {
    bool _match_20253 = (d > (0.0)); /*bool*/;
    if (_match_20253) {
      return kk_std_core_types__new_Gt(_ctx);
    }
    {
...
static inline bool kk_std_core_is_empty_2(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> bool */ 
  kk_string_t _x20867 = kk_string_empty(); /*string*/
  return kk_string_is_eq(s,_x20867,kk_context());
}
...
static inline kk_string_t kk_std_core__lp__bar__bar__1_rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> string */ 
  bool _match_20248;
  kk_string_t _x20869 = kk_string_dup(x); /*string*/
  kk_string_t _x20870 = kk_string_empty(); /*string*/
  _match_20248 = kk_string_is_eq(_x20869,_x20870,kk_context()); /*bool*/
  if (_match_20248) {
...
static inline kk_string_t kk_std_core_show_exp(double d, kk_std_core_types__optional precision, kk_context_t* _ctx) { /* (d : float64, precision : optional<int>) -> string */ 
  int32_t _x20995;
  kk_integer_t _x20996;
  if (kk_std_core_types__is_Optional(precision)) {
    kk_box_t _box_x18991 = precision._cons.Optional.value;
    kk_integer_t _precision_8116 = kk_integer_unbox(_box_x18991);
    _x20996 = _precision_8116; /*int*/
  }
  else {
    _x20996 = kk_integer_from_small(-17); /*int*/
  }
  _x20995 = kk_std_core_int32(_x20996, _ctx); /*int32*/
  return kk_std_core_show_expx(d, _x20995, _ctx);
}
...
static inline kk_string_t kk_std_core_show_2(kk_char_t c, kk_context_t* _ctx) { /* (c : char) -> string */ 
  kk_string_t _x21064;
  kk_define_string_literal(, _s21065, 1, "\'")
  _x21064 = kk_string_dup(_s21065); /*string*/
  kk_string_t _x21066;
  kk_string_t _x21067 = kk_std_core_show_char(c, _ctx); /*string*/
  kk_string_t _x21068;
  kk_define_string_literal(, _s21069, 1, "\'")
  _x21068 = kk_string_dup(_s21069); /*string*/
  _x21066 = kk_std_core__lp__plus__plus__1_rp_(_x21067, _x21068, _ctx); /*string*/
  return kk_std_core__lp__plus__plus__1_rp_(_x21064, _x21066, _ctx);
}
...
static inline kk_string_t kk_std_core_show_4(bool b, kk_context_t* _ctx) { /* (b : bool) -> string */ 
  if (b) {
    kk_define_string_literal(, _s21091, 4, "True")
    return kk_string_dup(_s21091);
  }
  {
    kk_define_string_literal(, _s21092, 5, "False")
    return kk_string_dup(_s21092);
  }
}
...
static inline kk_string_t kk_std_core_show_5(kk_unit_t u, kk_context_t* _ctx) { /* (u : ()) -> string */ 
  kk_define_string_literal(, _s21093, 2, "()")
  return kk_string_dup(_s21093);
}
...
static inline kk_string_t kk_std_core_show_6(kk_std_core__sslice s, kk_context_t* _ctx) { /* (s : sslice) -> string */ 
  kk_string_t _x21094 = kk_std_core_string_3(s, _ctx); /*string*/
  return kk_std_core_show_3(_x21094, _ctx);
}
...
static inline kk_string_t kk_std_core_show_7(kk_std_core__list xs, kk_context_t* _ctx) { /* (xs : list<string>) -> string */ 
  return kk_std_core__lift17480_show_7(xs, _ctx);
}
...
static inline kk_string_t kk_std_core_show_8(kk_std_core__list xs, kk_context_t* _ctx) { /* (xs : list<int>) -> string */ 
  return kk_std_core__lift17482_show_8(xs, _ctx);
}
...
static inline kk_string_t kk_std_core_show_9(kk_std_core__list xs, kk_context_t* _ctx) { /* (xs : list<bool>) -> string */ 
  return kk_std_core__lift17484_show_9(xs, _ctx);
}
...
static inline kk_unit_t kk_std_core_println_1(kk_integer_t i, kk_context_t* _ctx) { /* (i : int) -> console () */ 
  kk_string_t _x21147 = kk_std_core_show(i, _ctx); /*string*/
  kk_std_core_printsln(_x21147, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_println_2(double d, kk_context_t* _ctx) { /* (d : float64) -> console () */ 
  kk_string_t _x21148 = kk_std_core_show_1(d, kk_std_core_types__new_None(_ctx), _ctx); /*string*/
  kk_std_core_printsln(_x21148, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_println_3(bool b, kk_context_t* _ctx) { /* (b : bool) -> console () */ 
  kk_string_t _x21149;
  if (b) {
    kk_define_string_literal(, _s21150, 4, "True")
    _x21149 = kk_string_dup(_s21150); /*string*/
  }
  else {
    kk_define_string_literal(, _s21151, 5, "False")
    _x21149 = kk_string_dup(_s21151); /*string*/
  }
  kk_std_core_printsln(_x21149, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_println_4(kk_char_t c, kk_context_t* _ctx) { /* (c : char) -> console () */ 
  kk_string_t _x21152 = kk_std_core_string(c, _ctx); /*string*/
  kk_std_core_printsln(_x21152, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_println_5(kk_unit_t u, kk_context_t* _ctx) { /* (u : ()) -> console () */ 
  kk_string_t _x21153;
  kk_define_string_literal(, _s21154, 2, "()")
  _x21153 = kk_string_dup(_s21154); /*string*/
  kk_std_core_printsln(_x21153, _ctx); return kk_Unit;
}
...
static inline kk_box_t kk_std_core_throw_exn(kk_std_core__exception exn0, kk_context_t* _ctx) { /* forall<a> (exn : exception) -> exn a */ 
  kk_std_core_hnd__ev ev_18221;
  kk_ssize_t _x21159 = (KK_IZ(0)); /*ssize_t*/
  ev_18221 = kk_evv_at(_x21159,kk_context()); /*std/core/hnd/ev<.hnd-exn>*/
  {
    struct kk_std_core_hnd_Ev* _con21160 = kk_std_core_hnd__as_Ev(ev_18221);
    kk_std_core_hnd__marker m0 = _con21160->marker;
    kk_box_t _box_x19111 = _con21160->hnd;
    kk_std_core__hnd_exn h = kk_std_core__hnd_exn_unbox(_box_x19111, NULL);
    kk_std_core__hnd_exn_dup(h);
    kk_std_core_hnd__clause1 _match_20189;
    kk_std_core_hnd__clause1 _brw_20190 = kk_std_core__select_throw_exn(h, _ctx); /*std/core/hnd/clause1<exception,1938,.hnd-exn,1939,1940>*/;
    kk_std_core__hnd_exn_drop(h, _ctx);
    _match_20189 = _brw_20190; /*std/core/hnd/clause1<exception,1938,.hnd-exn,1939,1940>*/
    {
      kk_function_t _fun_unbox_x19115 = _match_20189.clause;
      return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x19115, (_fun_unbox_x19115, m0, ev_18221, kk_std_core__exception_box(exn0, _ctx), _ctx));
    }
  }
}
...
static inline kk_std_core__sslice kk_std_core_before(kk_std_core__sslice slice0, kk_context_t* _ctx) { /* (slice : sslice) -> sslice */ 
  {
    ...
    kk_string_dup(s);
    kk_std_core__sslice_drop(slice0, _ctx);
    kk_ssize_t _x21198 = (KK_IZ(0)); /*ssize_t*/
    return kk_std_core__new_Sslice(s, _x21198, start0, _ctx);
  }
}
...
static inline bool kk_std_core_bool(kk_integer_t i, kk_context_t* _ctx) { /* (i : int) -> bool */ 
  bool _brw_20182 = kk_integer_neq_borrow(i,(kk_integer_from_small(0)),kk_context()); /*bool*/;
...
static inline bool kk_std_core_bool_2(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> bool */ 
  kk_string_t _x21199 = kk_string_empty(); /*string*/
  return kk_string_is_neq(s,_x21199,kk_context());
}
...
static inline kk_std_core__error kk_std_core__mlift18016_try_1(kk_box_t _y_17723, kk_context_t* _ctx) { /* forall<a,e> (a) -> <exn|e> error<a> */ 
  return kk_std_core__new_Ok(_y_17723, _ctx);
}
...
static inline kk_std_core_types__maybe kk_std_core_for_whilez(kk_ssize_t start0, kk_ssize_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (start : ssize_t, end : ssize_t, action : (ssize_t) -> e maybe<a>) -> e maybe<a> */ 
  return kk_std_core__lift17285_for_whilez(action, end, start0, _ctx);
}
...
static inline kk_std_core__sslice kk_std_core_slice(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> sslice */ 
  kk_string_t _x21260 = kk_string_dup(s); /*string*/
  kk_ssize_t _x21261 = (KK_IZ(0)); /*ssize_t*/
  kk_ssize_t _x21262 = kk_string_len(s,kk_context()); /*ssize_t*/
  return kk_std_core__new_Sslice(_x21260, _x21261, _x21262, _ctx);
}
...
static inline kk_std_core_types__maybe kk_std_core_foreach_while_2(kk_string_t s, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (s : string, action : (c : char) -> e maybe<a>) -> e maybe<a> */ 
  kk_std_core__sslice _x21275;
  kk_string_t _x21276 = kk_string_dup(s); /*string*/
  kk_ssize_t _x21277 = (KK_IZ(0)); /*ssize_t*/
  kk_ssize_t _x21278 = kk_string_len(s,kk_context()); /*ssize_t*/
  _x21275 = kk_std_core__new_Sslice(_x21276, _x21277, _x21278, _ctx); /*sslice*/
  return kk_std_core_foreach_while_1(_x21275, action, _ctx);
}
...
static inline kk_std_core_types__maybe kk_std_core_foreach_while_3(kk_vector_t v, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,e> (v : vector<a>, f : (a) -> e maybe<b>) -> e maybe<b> */ 
  kk_ssize_t start0_17114 = (KK_IZ(0)); /*ssize_t*/;
  kk_ssize_t end_17115;
  kk_ssize_t _x21284 = kk_vector_len_borrow(v); /*ssize_t*/
  end_17115 = kk_std_core_decr_1(_x21284, _ctx); /*ssize_t*/
  return kk_std_core__lift17286_foreach_while_3(end_17115, f, v, start0_17114, _ctx);
}
...
static inline kk_unit_t kk_std_core__mlift18023_foreach_1(kk_std_core_types__maybe wild__0, kk_context_t* _ctx) { /* forall<_a,e> (wild_0 : maybe<_a>) -> e () */ 
...
static inline kk_unit_t kk_std_core__mlift18025_foreach_2(kk_std_core_types__maybe wild__0, kk_context_t* _ctx) { /* forall<_a,e> (wild_0 : maybe<_a>) -> e () */ 
  kk_std_core_types__maybe_drop(wild__0, _ctx);
  kk_Unit; return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_foreach_3(kk_vector_t v, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (v : vector<a>, f : (a) -> e ()) -> e () */ 
  kk_ssize_t start0_17121 = (KK_IZ(0)); /*ssize_t*/;
  kk_ssize_t end_17122;
  kk_ssize_t _x21315 = kk_vector_len_borrow(v); /*ssize_t*/
  end_17122 = kk_std_core_decr_1(_x21315, _ctx); /*ssize_t*/
  kk_std_core__lift17287_foreach_3(end_17122, f, v, start0_17121, _ctx); return kk_Unit;
}
...
static inline kk_std_core__delayed kk_std_core_delay(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> e a) -> delayed<e,a> */ 
  kk_ref_t _x21329;
  kk_box_t _x21330;
  kk_std_core_types__either _x21331 = kk_std_core_types__new_Left(kk_function_box(action), _ctx); /*either<1024,1025>*/
  _x21330 = kk_std_core_types__either_box(_x21331, _ctx); /*1000*/
  _x21329 = kk_ref_alloc(_x21330,kk_context()); /*ref<1001,1000>*/
  return kk_std_core__new_Delay(_x21329, _ctx);
}
...
static inline kk_std_core_types__maybe kk_std_core_find(kk_std_core__list xs, kk_function_t pred, kk_context_t* _ctx) { /* forall<a> (xs : list<a>, pred : (a) -> bool) -> maybe<a> */ 
  return kk_std_core__lift17489_find(pred, xs, _ctx);
}
...
static inline kk_box_t kk_std_core_fold_int_1(kk_integer_t upto, kk_box_t init0, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (upto : int, init : a, f : (int, a) -> e a) -> e a */ 
  kk_integer_t _x21472 = kk_integer_add_small_const(upto, -1, _ctx); /*int*/
  return kk_std_core_fold_int(kk_integer_from_small(0), _x21472, init0, f, _ctx);
}
...
static inline kk_std_core__list kk_std_core_reverse(kk_std_core__list xs, kk_context_t* _ctx) { /* forall<a> (xs : list<a>) -> list<a> */ 
  return kk_std_core__lift17288_reverse(kk_std_core__new_Nil(_ctx), xs, _ctx);
}
...
static inline kk_box_t kk_std_core_foldr(kk_std_core__list xs, kk_box_t z, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,e> (xs : list<a>, z : b, f : (a, b) -> e b) -> e b */ 
  kk_std_core__list xs00 = kk_std_core__lift17288_reverse(kk_std_core__new_Nil(_ctx), xs, _ctx); /*list<12443>*/;
  return kk_std_core__lift17490_foldr(f, xs00, z, _ctx);
}
...
static inline kk_unit_t kk_std_core_for(kk_integer_t start0, kk_integer_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (start : int, end : int, action : (int) -> e ()) -> e () */ 
  kk_integer_t _x21496 = kk_integer_dup(start0); /*int*/
  kk_std_core__lift17289_for(action, end, _x21496, _ctx); return kk_Unit;
}
...
static inline kk_std_core_types__maybe kk_std_core_for_while(kk_integer_t start0, kk_integer_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (start : int, end : int, action : (int) -> e maybe<a>) -> e maybe<a> */ 
  return kk_std_core__lift17290_for_while(action, end, start0, _ctx);
}
...
static inline kk_unit_t kk_std_core_foreach_indexed_1(kk_vector_t v, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (v : vector<a>, f : (int, a) -> e ()) -> e () */ 
  kk_ssize_t start0_17167 = (KK_IZ(0)); /*ssize_t*/;
  kk_ssize_t end_17168;
  kk_ssize_t _x21539 = kk_vector_len_borrow(v); /*ssize_t*/
  end_17168 = kk_std_core_decr_1(_x21539, _ctx); /*ssize_t*/
  kk_std_core__lift17291_foreach_indexed_1(end_17168, f, v, start0_17167, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_print_1(kk_integer_t i, kk_context_t* _ctx) { /* (i : int) -> console () */ 
  kk_string_t _x21540 = kk_std_core_show(i, _ctx); /*string*/
  kk_std_core_prints(_x21540, _ctx); return kk_Unit;
}
 
// Print a float64 to the console.

static inline kk_unit_t kk_std_core_print_2(double d, kk_context_t* _ctx) { /* (d : float64) -> console () */ 
  kk_string_t _x21541 = kk_std_core_show_1(d, kk_std_core_types__new_None(_ctx), _ctx); /*string*/
  kk_std_core_prints(_x21541, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_print_3(bool b, kk_context_t* _ctx) { /* (b : bool) -> console () */ 
  kk_string_t _x21542;
  if (b) {
    kk_define_string_literal(, _s21543, 4, "True")
    _x21542 = kk_string_dup(_s21543); /*string*/
  }
  else {
    kk_define_string_literal(, _s21544, 5, "False")
    _x21542 = kk_string_dup(_s21544); /*string*/
  }
  kk_std_core_prints(_x21542, _ctx); return kk_Unit;
}
 
// Print a character to the console.

static inline kk_unit_t kk_std_core_print_4(kk_char_t c, kk_context_t* _ctx) { /* (c : char) -> console () */ 
  kk_string_t _x21545 = kk_std_core_string(c, _ctx); /*string*/
  kk_std_core_prints(_x21545, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_print_5(kk_unit_t u, kk_context_t* _ctx) { /* (u : ()) -> console () */ 
  kk_string_t _x21546;
  kk_define_string_literal(, _s21547, 2, "()")
  _x21546 = kk_string_dup(_s21547); /*string*/
  kk_std_core_prints(_x21546, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_gprint(kk_box_t x, kk_context_t* _ctx) { /* forall<a> (x : a) -> console () */ 
  kk_string_t s_17172 = kk_std_core_gshow(x, _ctx); /*string*/;
  kk_std_core_prints(s_17172, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_gprintln(kk_box_t x, kk_context_t* _ctx) { /* forall<a> (x : a) -> console () */ 
  kk_string_t s_17173 = kk_std_core_gshow(x, _ctx); /*string*/;
  kk_std_core_printsln(s_17173, _ctx); return kk_Unit;
}
...
static inline bool kk_std_core_is_alpha_num(kk_char_t c, kk_context_t* _ctx) { /* (c : char) -> bool */ 
  bool _match_20077 = kk_std_core_is_alpha(c, _ctx); /*bool*/;
  if (_match_20077) {
    return true;
  }
  {
    bool _match_20078 = (c >= ('0')); /*bool*/;
    if (_match_20078) {
      return (c <= ('9'));
    }
    {
...
static inline bool kk_std_core_is_notempty_1(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> bool */ 
  kk_string_t _x21574 = kk_string_empty(); /*string*/
  return kk_string_is_neq(s,_x21574,kk_context());
}
...
static inline bool kk_std_core_is_valid(kk_std_core__sslice slice0, kk_context_t* _ctx) { /* (slice : sslice) -> bool */ 
  ...
  kk_ssize_t _x21577 = (KK_IZ(0)); /*ssize_t*/
  return (_x21576 >= _x21577);
}
...
static inline kk_std_core__list kk_std_core_split_1(kk_string_t s, kk_string_t sep, kk_context_t* _ctx) { /* (s : string, sep : string) -> list<string> */ 
  kk_vector_t v_17194 = kk_string_splitv(s,sep,kk_context()); /*vector<string>*/;
  return kk_std_core_vlist(v_17194, kk_std_core_types__new_None(_ctx), _ctx);
}
...
static inline kk_std_core__list kk_std_core_split_2(kk_string_t s, kk_string_t sep, kk_integer_t n, kk_context_t* _ctx) { /* (s : string, sep : string, n : int) -> list<string> */ 
  kk_vector_t v_17195;
  kk_ssize_t _x21600;
  kk_integer_t _x21601 = kk_integer_dup(n); /*int*/
  _x21600 = kk_std_core_ssize__t(_x21601, _ctx); /*ssize_t*/
  v_17195 = kk_string_splitv_atmost(s,sep,_x21600,kk_context()); /*vector<string>*/
  return kk_std_core_vlist(v_17195, kk_std_core_types__new_None(_ctx), _ctx);
}
...
static inline kk_std_core__list kk_std_core_lines(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> list<string> */ 
  kk_vector_t v_17198;
  kk_string_t _x21602;
  kk_define_string_literal(, _s21603, 1, "\n")
  _x21602 = kk_string_dup(_s21603); /*string*/
  v_17198 = kk_string_splitv(s,_x21602,kk_context()); /*vector<string>*/
  return kk_std_core_vlist(v_17198, kk_std_core_types__new_None(_ctx), _ctx);
}
...
static inline kk_std_core_types__maybe kk_std_core_lookup(kk_std_core__list xs, kk_function_t pred, kk_context_t* _ctx) { /* forall<a,b> (xs : list<(a, b)>, pred : (a) -> bool) -> maybe<b> */ 
  return kk_std_core__lift17492_lookup(pred, xs, _ctx);
}
...
static inline kk_std_core__list kk_std_core_map_indexed(kk_std_core__list xs, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,e> (xs : list<a>, f : (idx : int, value : a) -> e b) -> e list<b> */ 
  return kk_std_core__lift17292_map_indexed(f, xs, kk_integer_from_small(0), _ctx);
}
...
static inline kk_std_core__list kk_std_core_map_indexed_peek(kk_std_core__list xs, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,e> (xs : list<a>, f : (idx : int, value : a, rest : list<a>) -> e b) -> e list<b> */ 
  return kk_std_core__lift17293_map_indexed_peek(f, xs, kk_integer_from_small(0), _ctx);
}
...
static inline kk_integer_t kk_std_core_max(kk_integer_t i, kk_integer_t j, kk_context_t* _ctx) { /* (i : int, j : int) -> int */ 
  bool _match_20045 = kk_integer_gte_borrow(i,j,kk_context()); /*bool*/;
  if (_match_20045) {
...
static inline kk_std_core_types__maybe kk_std_core_maybe_5(kk_integer_t i, kk_context_t* _ctx) { /* (i : int) -> maybe<int> */ 
  bool _match_20041 = kk_integer_eq_borrow(i,(kk_integer_from_small(0)),kk_context()); /*bool*/;
  if (_match_20041) {
    kk_integer_drop(i, _ctx);
    return kk_std_core_types__new_Nothing(_ctx);
  }
...
static inline kk_integer_t kk_std_core_min(kk_integer_t i, kk_integer_t j, kk_context_t* _ctx) { /* (i : int, j : int) -> int */ 
  bool _match_20039 = kk_integer_lte_borrow(i,j,kk_context()); /*bool*/;
  if (_match_20039) {
    kk_integer_drop(j, _ctx);
    return i;
  }
...
static inline kk_std_core__null kk_std_core_null_3(bool b, kk_context_t* _ctx) { /* (b : bool) -> null<()> */ 
  kk_std_core_types__maybe _x21708;
  if (b) {
    _x21708 = kk_std_core_types__new_Just(kk_unit_box(kk_Unit), _ctx); /*maybe<1034>*/
  }
  else {
    _x21708 = kk_std_core_types__new_Nothing(_ctx); /*maybe<1034>*/
  }
  return kk_std_core_null(_x21708, _ctx);
}
...
static inline kk_string_t kk_std_core_trim(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> string */ 
  kk_string_t _x21738 = kk_string_trim_left(s,kk_context()); /*string*/
  return kk_string_trim_right(_x21738,kk_context());
}
...
static inline kk_std_core_types__maybe kk_std_core_parse_int(kk_string_t s, kk_std_core_types__optional hex, kk_context_t* _ctx) { /* (s : string, hex : optional<bool>) -> maybe<int> */ 
  kk_string_t _x21739;
  kk_string_t _x21740 = kk_string_trim_left(s,kk_context()); /*string*/
  _x21739 = kk_string_trim_right(_x21740,kk_context()); /*string*/
  bool _x21741;
  if (kk_std_core_types__is_Optional(hex)) {
    kk_box_t _box_x19698 = hex._cons.Optional.value;
    bool _hex_15544 = kk_bool_unbox(_box_x19698);
    _x21741 = _hex_15544; /*bool*/
  }
  else {
    _x21741 = false; /*bool*/
  }
  return kk_std_core_xparse_int(_x21739, _x21741, _ctx);
}
...
static inline kk_std_core__list kk_std_core_remove(kk_std_core__list xs, kk_function_t pred, kk_context_t* _ctx) { /* forall<a> (xs : list<a>, pred : (a) -> bool) -> list<a> */ 
  return kk_std_core__lift17497_remove(pred, xs, _ctx);
}
...
static inline kk_string_t kk_std_core_repeat(kk_string_t s, kk_integer_t n, kk_context_t* _ctx) { /* (s : string, n : int) -> string */ 
  kk_ssize_t _x21774;
  kk_integer_t _x21775 = kk_integer_dup(n); /*int*/
  _x21774 = kk_std_core_ssize__t(_x21775, _ctx); /*ssize_t*/
  return kk_std_core_repeatz(s, _x21774, _ctx);
}
...
static inline kk_unit_t kk_std_core_repeat_1(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (n : int, action : () -> e ()) -> e () */ 
  kk_integer_t _x21780 = kk_integer_dup(n); /*int*/
  kk_std_core__lift17294_repeat_1(action, _x21780, kk_integer_from_small(1), _ctx); return kk_Unit;
}
...
static inline kk_std_core_types__tuple2_ kk_std_core_span(kk_std_core__list xs, kk_function_t predicate, kk_context_t* _ctx) { /* forall<a,e> (xs : list<a>, predicate : (a) -> e bool) -> e (list<a>, list<a>) */ 
  return kk_std_core__lift17297_span(predicate, xs, kk_std_core__new_Nil(_ctx), _ctx);
}
...
static inline kk_integer_t kk_std_core_sum(kk_std_core__list xs, kk_context_t* _ctx) { /* (xs : list<int>) -> int */ 
  return kk_std_core__lift17498_sum(xs, kk_integer_from_small(0), _ctx);
}
...
static inline kk_unit_t kk_std_core__mlift18056_trace(kk_string_t message0, bool _y_17910, kk_context_t* _ctx) { /* forall<_e> (message0 : string, bool) -> <read<global>|_e> () */ 
  if (_y_17910) {
...
static inline kk_unit_t kk_std_core__mlift18057_trace_any(kk_string_t message0, kk_box_t x, bool _y_17912, kk_context_t* _ctx) { /* forall<_e,a> (message0 : string, x : a, bool) -> <read<global>|_e> () */ 
  if (_y_17912) {
...
static inline kk_integer_t kk_std_core__mlift18058_unique(kk_integer_t u, kk_context_t* _ctx) { /* forall<_e> (u : int) -> <read<global>,write<global>|_e> int */ 
  kk_integer_t _b_19845_19843;
  kk_integer_t _x21880 = kk_integer_dup(u); /*int*/
  _b_19845_19843 = kk_integer_add_small_const(_x21880, 1, _ctx); /*int*/
  kk_unit_t __ = kk_Unit;
  kk_ref_set_borrow(kk_std_core_unique_count,(kk_integer_box(_b_19845_19843)),kk_context());
  return u;
}
...
static inline kk_std_core_types__tuple2_ kk_std_core_unzip(kk_std_core__list xs, kk_context_t* _ctx) { /* forall<a,b> (xs : list<(a, b)>) -> (list<a>, list<b>) */ 
  return kk_std_core__lift17299_unzip(xs, kk_std_core__new_Nil(_ctx), kk_std_core__new_Nil(_ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_vector_fun21918__t_2 {
  struct kk_function_s _base;
  kk_box_t default0;
};
extern kk_box_t kk_std_core_vector_fun21918_2(kk_function_t _fself, kk_ssize_t ___wildcard__1854__30, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_new_vector_fun21918_2(kk_box_t default0, kk_context_t* _ctx) {
  struct kk_std_core_vector_fun21918__t_2* _self = kk_function_alloc_as(struct kk_std_core_vector_fun21918__t_2, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_vector_fun21918_2, kk_context());
  _self->default0 = default0;
  return &_self->_base;
}
...
static inline kk_vector_t kk_std_core_vector_2(kk_integer_t n, kk_box_t default0, kk_context_t* _ctx) { /* forall<a> (n : int, default : a) -> vector<a> */ 
  kk_ssize_t _x21916;
  kk_integer_t _x21917 = kk_integer_dup(n); /*int*/
  _x21916 = kk_std_core_ssize__t(_x21917, _ctx); /*ssize_t*/
  return kk_std_core_vector_initz(_x21916, kk_std_core_new_vector_fun21918_2(default0, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_vector_init_fun21921__t {
  struct kk_function_s _base;
  kk_function_t f;
};
extern kk_box_t kk_std_core_vector_init_fun21921(kk_function_t _fself, kk_ssize_t i, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_new_vector_init_fun21921(kk_function_t f, kk_context_t* _ctx) {
  struct kk_std_core_vector_init_fun21921__t* _self = kk_function_alloc_as(struct kk_std_core_vector_init_fun21921__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_vector_init_fun21921, kk_context());
  _self->f = f;
  return &_self->_base;
}
...
static inline kk_vector_t kk_std_core_vector_init(kk_integer_t n, kk_function_t f, kk_context_t* _ctx) { /* forall<a> (n : int, f : (int) -> a) -> vector<a> */ 
  kk_ssize_t _x21919;
  kk_integer_t _x21920 = kk_integer_dup(n); /*int*/
  _x21919 = kk_std_core_ssize__t(_x21920, _ctx); /*ssize_t*/
  return kk_std_core_vector_initz(_x21919, kk_std_core_new_vector_init_fun21921(f, _ctx), _ctx);
}
...
static inline kk_std_core__list kk_std_core_zipwith_indexed(kk_std_core__list xs0, kk_std_core__list ys0, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,c,e> (xs0 : list<a>, ys0 : list<b>, f : (int, a, b) -> e c) -> e list<c> */ 
  return kk_std_core__lift17302_zipwith_indexed(f, kk_integer_from_small(0), xs0, ys0, _ctx);
}
